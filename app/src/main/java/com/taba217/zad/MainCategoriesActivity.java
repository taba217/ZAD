...
public class MainCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder()
                .build();
        navController = Navigation.findNavController(this, R.id.categories_nav_view);
    ...
    protected void onStart() {
        ...
        bundle.putString("category_type", getIntent().getExtras().getString("category_type"));
        navController.navigate(R.id.mainCategories, bundle);
    }
}
